...
class InMemoryConfigRepository : public Core::Domain::IConfigRepository {
private:
...
public:
    InMemoryConfigRepository() {
        config.chargePointId = "ESP32_CP_001";
        config.centralSystemUrl = ""; // fallback handled in OCPPClient
        config.heartbeatInterval = 300;
        config.meterValueSampleInterval = 60;
...
class InMemoryTransactionRepository : public Core::Domain::ITransactionRepository {
private:
